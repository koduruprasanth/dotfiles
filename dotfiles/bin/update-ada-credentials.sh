...
sleep 14 && ada credentials update --account=041996936009 --provider=conduit --role=IibsAdminAccess-DO-NOT-DELETE --profile=prasantk &
sleep 15 && ada credentials update --account=171311505222 --provider=conduit --role=IibsAdminAccess-DO-NOT-DELETE --profile=candidate-shipment-simulator-prod &
